...
const Color secondary = Color(0xFFFFE24B);
...
Color darkContainer = white.withAlpha(1);

// Button colors
const Color buttonPrimary = Color(0xFF4b68ff);
...
const Color darkgrey = const Color.fromRGBO(27, 22, 22, 1);
const Color blue = const Color.fromRGBO(46, 82, 210, 1);
